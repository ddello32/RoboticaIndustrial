...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{banana}
...
\begin{itemize}
	...
	Conforme solicitado no roteiro\cite{bb:roteiro}, foi considerada somente a energia cinética do problema, ou seja, consideramos a gravidade igual a zero. Logo, o torque final que compensa a força da gravidade é zero.
